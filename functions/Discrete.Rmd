...
````
We can derive the previous bandwidth selectiors for an unordered discrete predictor, just by defining the ukertype argument inside npreg with Aitchison kernels.
